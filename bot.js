...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'sa') {
      msg.reply('Aleyküm Selam Sunucuya Hoşgeldin.');
}
if (msg.content.toLowerCase() === 'g!davet') {
    msg.reply('https://discordapp.com/oauth2/authorize?client_id=531848921870237716&scope=bot&permissions=805829694');
}
});
